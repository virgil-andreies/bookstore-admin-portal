...
export class BookListComponent implements OnInit {
  ...
  openDialog(book: Book) {
    const dialogRef = this.dialog.open(DialogResultExDialogComponent);
...
@Component({
  selector: 'app-dialog-result-ex-dialog',
  templateUrl: './dialog-result-ex-dialog.html'
})
export class DialogResultExDialogComponent {
  constructor(public dialogRef: MatDialogRef<DialogResultExDialogComponent>) {
  }
}
